...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="col-lg-8">
                <form method="post" action="/dasboard/post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="penulis" required value="{{ old('penulis') }}"
                            name="penulis">
                        @error('penulis')
                            <p class="text-danger">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slug" required value="{{ old('slug') }}"
                            name="slug">
                        @error('slug')
                            <p class="text-danger">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="id_categories">
                            @foreach ($categories as $category)
                                @if (old('id_categories') == $category->id_categories)
                  ...
                  @enderror
                    <div class="mb-3">
                        ...
                        <input id="isiPost" type="hidden" name="isiPost" value="{{ old('isiPost') }}">
